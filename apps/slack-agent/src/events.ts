...
import { MAX_APP_MENTION_THREAD_MESSAGES, buildSlackAppMentionContext } from "../../../packages/core/src/slack/app-mention-context.js";
import { buildSlackTriageActionBlocks, buildSlackTriageActionText, buildSlackTriagePrompt, parsePendingActionInteraction, parseSlackTriageDecision, suggestSlackTriageFallback } from "../../../packages/core/src/slack/triage-flow.js";
import { formatTriageContexts, loadTriageContextProjection, normalizeTriageContext, persistTriageContextProjection } from "../../../packages/core/src/slack/triage-context.js";
...
export function createSlackEventHandlers(ctx: any) {
  const {
    config, slackDomainStore, finalizedTriageJobs, triageJobResults, localSlackMemory,
    slackWorkspaceDir, slackInbound, runner, poster, slackMessageBuffers, workspaceContext,
    activeSlackMentionThreads, recentSlackMentionEvents, executeAvatarCommand,
    callSlackApi, startSlackSocketMode, shouldKeepAssistantStatusUntilWorkerDone, slackImmediateWorkerAckText,
  } = ctx;
