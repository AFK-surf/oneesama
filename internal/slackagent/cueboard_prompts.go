...
- MAYBE — low-stakes thread, including a fresh factual / current-events question, where one short useful reply might help after checking context
...
- Do not skip a factual question only because it is casual; if one verified fact would answer it, investigate lightly
