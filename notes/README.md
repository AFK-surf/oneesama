...
| `notes/rfc/realtime-low-latency-cueboard-cu-execution-plane-rfc-2026-06-02.md` | Proposed rewrite architecture.            | Makes Realtime a low-latency routing layer and rewrites KWWK/Cueboard CU as the model-first structured execution plane for simple app control, with cursor, interrupt, English-output, and strict benchmark gates. |
